...
public final class MSSQLApplyLogConfig
{
    ...
    private final String winBackupDirStr;
    ...
    public String getWinBackupDirStr()
    {
        return winBackupDirStr;
    }
                                ...
                                final Boolean monitorLogBackupDir)
    {
        ...
        this.winBackupDirStr = winBackupDirStr;
